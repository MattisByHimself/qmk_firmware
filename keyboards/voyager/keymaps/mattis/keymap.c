...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, DE_LESS,        DE_MORE,        DE_PIPE,        KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LGUI(DE_ACUT),  
                                                    KC_LEFT_GUI,    KC_TRANSPARENT,                                 KC_ENTER,       MT(MOD_RALT, KC_DELETE)
  ),
  [2] = LAYOUT_voyager(
