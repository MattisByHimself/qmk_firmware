...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    KC_LEFT_CTRL,   MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_S),MT(MOD_LCTL, KC_D),MT(MOD_LSFT, KC_F),KC_G,                                           KC_H,           MT(MOD_RSFT, KC_J),MT(MOD_RCTL, KC_K),MT(MOD_RALT, KC_L),MT(MOD_RGUI, DE_OE),DE_AE,          
    KC_LEFT_SHIFT,  DE_Y,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         DE_MINS,        KC_MEH,         
  ...
  [1] = LAYOUT_voyager(
    ...
    DE_ACUT,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, DE_LBRC,        DE_RBRC,                                        DE_LCBR,        DE_RCBR,        KC_TRANSPARENT, DE_HASH,        DE_PLUS,        KC_F12,         
    KC_TRANSPARENT, TD(DANCE_0),    TD(DANCE_1),    TD(DANCE_2),    TD(DANCE_3),    DE_PERC,                                        DE_AMPR,        TD(DANCE_4),    TD(DANCE_5),    TD(DANCE_6),    TD(DANCE_7),    DE_QST,         
    KC_TRANSPARENT, DE_LESS,        DE_MORE,        DE_PIPE,        KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [2] = LAYOUT_voyager(
    RGB_TOG,        TOGGLE_LAYER_COLOR,RGB_MODE_FORWARD,RGB_SLD,        RGB_VAD,        RGB_VAI,                                        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(3),          
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_LEFT_SHIFT,  DE_Y,           KC_X,           KC_C,           KC_V,           KC_B,                                           KC_N,           KC_M,           KC_COMMA,       KC_DOT,         DE_MINS,        KC_MEH,         
                                                    KC_LEFT_GUI,    KC_SPACE,                                       LT(4,KC_ENTER), KC_BSPC
  ),
  [4] = LAYOUT_voyager(
...
void dance_2_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[2].step) {
        case SINGLE_TAP: register_code16(DE_PARA); break;
        case SINGLE_HOLD: register_code16(KC_LEFT_CTRL); break;
        case DOUBLE_TAP: register_code16(DE_PARA); register_code16(DE_PARA); break;
        case DOUBLE_SINGLE_TAP: tap_code16(DE_PARA); register_code16(DE_PARA);
    }
}
...
void dance_2_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[2].step) {
        case SINGLE_TAP: unregister_code16(DE_PARA); break;
        case SINGLE_HOLD: unregister_code16(KC_LEFT_CTRL); break;
        case DOUBLE_TAP: unregister_code16(DE_PARA); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(DE_PARA); break;
    }
...
void dance_7_finished(tap_dance_state_t *state, void *user_data) {
    ...
    switch (dance_state[7].step) {
        case SINGLE_TAP: register_code16(DE_EQL); break;
        case SINGLE_HOLD: register_code16(KC_RIGHT_GUI); break;
        case DOUBLE_TAP: register_code16(DE_EQL); register_code16(DE_EQL); break;
        case DOUBLE_SINGLE_TAP: tap_code16(DE_EQL); register_code16(DE_EQL);
    }
}
...
void dance_7_reset(tap_dance_state_t *state, void *user_data) {
    wait_ms(10);
    switch (dance_state[7].step) {
        case SINGLE_TAP: unregister_code16(DE_EQL); break;
        case SINGLE_HOLD: unregister_code16(KC_RIGHT_GUI); break;
        case DOUBLE_TAP: unregister_code16(DE_EQL); break;
        case DOUBLE_SINGLE_TAP: unregister_code16(DE_EQL); break;
    }
